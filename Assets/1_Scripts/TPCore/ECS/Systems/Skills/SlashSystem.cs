...
{
    public class SlashSystem : IEcsRunSystem
    {
        private readonly EcsWorldInject _world = default;
        private readonly EcsFilterInject<Inc<SkillComponent, SlashComponent, FireEvent>> _fireFilter = default;
        ...
        private void OnFire()
        {
            foreach (int entity in _fireFilter.Value)
            {
                ...
                {
                    int projectileEntity = ProjectileFactory<SlashComponent>.GetProjectile(_world.Value, skill.Data);
