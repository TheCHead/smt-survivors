...
{
    public class TopDownMovementSystem : IEcsInitSystem, IEcsRunSystem
    {
        private readonly EcsWorldInject _world = default;
        private readonly EcsFilterInject<Inc<PlayerTag, TransformComponent, TopDownMoverComponent>> _playerMoveEntities = default;
